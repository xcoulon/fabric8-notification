PROJECT_NAME=fabric8-notification
PACKAGE_NAME := github.com/fabric8-services/fabric8-notification
...
template/bindata.go: $(GO_BINDATA_BIN) $(wildcard template/*/*.html)
	$(GO_BINDATA_BIN) \
...
generate: app/controllers.go template/bindata.go
